...
export const ViewProductInDetail = ({ wishlistItems, setwishlistItems }) => {
  const { id } = useParams();
  ...
  useEffect(() => {
    setproductitem(
      productJSON && productJSON.filter((product) => product.id == id)
    );
  }, [productJSON, id]);
          ...
          {productitem && (
            <div className="container  mx-auto">
              <div className="lg:w-4/5 mx-auto flex flex-wrap items-start">
                <img
                  alt="ecommerce"
                  className="lg:w-1/2 hover:scale-150 hover:border hover:p-2 hover:z-10 bg-white w-full cursor-pointer mt-10 h-auto object-contain rounded"
